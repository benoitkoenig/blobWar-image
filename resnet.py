...
class Residual(Model):
    def __init__(self, K, red):
        super(Residual, self).__init__()
        self.red = red
        strides = (1, 1)
        self.input1 = InputLayer()
        if (red == True):
            strides = (2, 2)
...
class ResNet(Model):
    def __init__(self):
        ...
        self.bn1 = BatchNormalization()
        self.conv1 = Conv2D(16, (5, 5), padding="same")
        self.bn2 = BatchNormalization()
        self.act1 = Activation("relu")
        self.zp1 = ZeroPadding2D((1, 1))
        self.mp1 = MaxPooling2D((3, 3), strides=(2, 2))
        self.res1 = Residual(64, True)
        self.res2 = Residual(64, False)
        self.res3 = Residual(64, False)
        self.res4 = Residual(32, True)
        self.res5 = Residual(32, False)
        self.res6 = Residual(32, False)
        self.res7 = Residual(16, True)
        self.res8 = Residual(16, False)
        self.res9 = Residual(16, False)
        self.bn3 = BatchNormalization()
        self.act2 = Activation("relu")
